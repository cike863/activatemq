...
public class JMSCustomerB {
    ...
    public static void main(String[] args) {
        ...
        //实例化连接工厂
        connectionFactory = new ActiveMQConnectionFactory(JMSCustomerB.USERNAME, JMSCustomerB.PASSWORD, JMSCustomerB.BROKEURL);
        try {
            ...
            messageConsumer.setMessageListener(new ListenerB());//注册消息监听
        } catch (Exception e) {
            e.printStackTrace();
        }
